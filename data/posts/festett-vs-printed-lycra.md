...
## A kézzel festett vonal

A festett darabjaink organikus motívumokat hordoznak: lágy átmenetek,
természeti formák, kézi ecsetnyomok. Két dolog miatt nem cserélhetők le
nyomtatott mintára:

- **UV-aktív festék.** A felhasznált pigmentek nagy része UV-fény alatt
  másodlagos színt és fényhatást ad. Egy nappal "csak" szép szövet
  estére a megfelelő UV-lámpázással önálló látvány.
- **Egyediség.** Minden darab egyetlen példányban létezik. Aki azt
  szeretné, hogy a rendezvénye ne legyen sablonos, ezt a vonalat
  keresi.

Tipikus felhasználói: fesztiválok, természeti közegben tartott
...
- **Geometria és márkás minta.** Logo, vonalas grafika, fotóminőségű
  képi tartalom egységes minőségben jeleníthető meg.
- **Sorozatban gyártható.** Egy nagyobb kampány több helyszínén ugyanaz
  a látvány reprodukálható.

Tipikus felhasználói: konferenciák, márka-aktivációk, B2B
brand-rendezvények, sportesemény-helyszínek, városi PR-akciók.
...
A festett darabjaink többségéhez tartozik egy UV-lámpás javaslat:
melyik felület melyik szögből és milyen távolságból világítva ad
optimális hatást. A világító-eszközöket a megrendelő vagy a rendezvény
technikai partnere biztosítja — ebben szívesen segítünk a megfelelő
specifikáció kiválasztásában. (Erről külön cikkben írunk részletesen.)
...
- Telepítés és bontás saját csapattal — az emelőgépek és a tartóállvány
  jellemzően az ügyfélé vagy a többi alvállalkozóé, mi a dekor-pakkot
  szállítjuk és feszítjük ki.
- Szállítás csomagolt állapotban; a textil minimális helyet foglal.
- Helyreállítás és tisztítás a rendezvény után, készletünkbe vissza.
